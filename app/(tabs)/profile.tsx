                ...
                <Animated.View style={{ opacity: fadeAnim }}>
                    ...
                    <View style={dashStyles.header}>
                        ...
                        <View style={dashStyles.headerInfo}>
                            <Text style={dashStyles.name}>{fullName || "Mike Henson"}</Text>
                    ...
                    <TouchableOpacity style={dashStyles.calculateBtn}>
                        <Text style={dashStyles.calculateBtnText}>Calculate the standards</Text>
                    </TouchableOpacity>
        ...
        >
            ...
            >
                <View style={editStyles.header}>
                    <Text style={editStyles.title}>Personal account</Text>
...
const dashStyles = StyleSheet.create({
    ...
    calculateBtn: {
        backgroundColor: '#76A165', marginHorizontal: 16, height: 56,
        borderRadius: 16, justifyContent: 'center', alignItems: 'center',
        marginBottom: 16, shadowColor: '#000', shadowOpacity: 0.1, shadowRadius: 5,
    },
